...
describe('ConfigManager', () => {
  ...
  test('appearance defaults', async () => {
    ...
    expect(configManager.isBrandShown(hawtconfig)).toBe(true)
    expect(configManager.isUserHeaderShown(hawtconfig)).toBe(true)
    expect(configManager.isSideBarShown(hawtconfig)).toBe(true)
  })
})
